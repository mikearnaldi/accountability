...
const ACTION_LABELS: Record<string, string> = {
  ...
  "fiscal_period:open": "Fiscal Period: Open",
  "fiscal_period:soft_close": "Fiscal Period: Soft Close",
  "fiscal_period:close": "Fiscal Period: Close",
  "fiscal_period:lock": "Fiscal Period: Lock",
  "fiscal_period:reopen": "Fiscal Period: Reopen",
