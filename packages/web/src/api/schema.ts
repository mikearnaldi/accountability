export interface paths {
    ...
    "/api/v1/fiscal/fiscal-years": {
         ...
         */
        get: operations["fiscalPeriods.listFiscalYears"];
        put?: never;
        /**
         * Create fiscal year
         ...
         */
        post: operations["fiscalPeriods.createFiscalYear"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/fiscal/fiscal-years/{id}": {
         ...
         */
        get: operations["fiscalPeriods.getFiscalYear"];
        put?: never;
        post?: never;
        /**
         * Delete fiscal year
         ...
         */
        delete: operations["fiscalPeriods.deleteFiscalYear"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    };
    "/api/v1/fiscal/fiscal-periods": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         */
        get: operations["fiscalPeriods.listFiscalPeriods"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/fiscal/fiscal-periods/{id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         */
        get: operations["fiscalPeriods.getFiscalPeriod"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/fiscal/fiscal-periods/{id}/open": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         */
        post: operations["fiscalPeriods.openPeriod"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/fiscal/fiscal-periods/{id}/close": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         */
        post: operations["fiscalPeriods.closePeriod"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/fiscal/fiscal-periods/{id}/soft-close": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         */
        post: operations["fiscalPeriods.softClosePeriod"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/fiscal/fiscal-periods/{id}/reopen": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         */
        post: operations["fiscalPeriods.reopenPeriod"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/fiscal/current": {
         ...
         */
        get: operations["fiscalPeriods.getCurrentPeriod"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        FiscalPeriod: {
            ...
            /**
             * lessThanOrEqualTo(13)
             * @description a number less than or equal to 13
             */
            periodNumber: number;
            name: components["schemas"]["NonEmptyTrimmedString"];
        ...
        ClosePeriodRequest: {
            closedBy: components["schemas"]["UserId"];
        };
        SoftClosePeriodRequest: {
            closedBy: components["schemas"]["UserId"];
        };
        ReopenPeriodRequest: {
...
export interface operations {
    ...
    "fiscalPeriods.createFiscalYear": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        responses: {
            /** @description FiscalYearWithPeriodsResponse */
            201: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["FiscalYearWithPeriodsResponse"];
                };
            };
            /** @description The request did not match the expected schema */
            400: {
    ...
    "fiscalPeriods.deleteFiscalYear": {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    "fiscalPeriods.listFiscalPeriods": {
        parameters: {
            query?: {
                fiscalYearId?: components["schemas"]["FiscalYearId"];
                companyId?: components["schemas"]["CompanyId"];
    ...
    "fiscalPeriods.softClosePeriod": {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["SoftClosePeriodRequest"];
            };
        };
        responses: {
            /** @description FiscalPeriod */
    ...
    "fiscalPeriods.reopenPeriod": {
        ...
        responses: {
            /** @description ReopenPeriodResponse */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["ReopenPeriodResponse"];
                };
            };
            /** @description The request did not match the expected schema */
            400: {
    ...
    "fiscalPeriods.getCurrentPeriod": {
        parameters: {
            query: {
                companyId: components["schemas"]["CompanyId"];
            };
